...
import { TaskCardOptions } from '@/components/new/TaskCard';
import { CreateTaskModal, TaskEditData } from '@/components/new/CreateTaskModal';
...
function TaskList({ tasks, options, onComplete, onIgnore, onEdit, onDelete }: TaskListProps) {
    return (
